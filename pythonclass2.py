...
while i==0:
    while userinput3_option != 3:
        if userinput3_option == 1:
            ...
            print(f"You have deposited {deposit} dollars in your account. Thank you!")
            ...
            while option != 3:
                ...
                if option == 1:
                    ...
                    if withdrawal > 500 or withdrawal > deposit:
                        print("You cannot withdraw more than the limit of 500 or than your account balance")
                    else:
                        print(f"You have withdrawn {withdrawal} dollars")
                else:
                    userinput3_option = 3
            ...
            withdrawal = int(input("How much money would you like to withdraw? "))
            if withdrawal > 500:
                print("You cannot withdraw more than the limit of 500")
            else:
                print(f"You have withdrawn {withdrawal} dollars")
            ...
            while option != 3:
                ...
                if option == 1:
                    ...
                    withdrawal = int(input("How much money would you like to withdraw? "))
                    if withdrawal > 500 or (withdrawal > deposit and deposit > 0):
                        print("You cannot withdraw more than the limit of 500 or than your account balance")
                    else:
                        print(f"You have withdrawn {withdrawal} dollars")
                else:
